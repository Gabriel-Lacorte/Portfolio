...
Neste guia vamos usar o Debian 12 netinstall como sistema operacional ([baixar ISO](https://www.debian.org/distrib/netinst)), por ser leve, seguro e estável. A escolha pode variar conforme sua preferência: para quem está começando em self-hosting, recomendo o Debian; fora isso, opções como Ubuntu Server ou Fedora também servem. Para um NAS, o TrueNAS é altamente recomendado.
