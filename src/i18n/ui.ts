...
const en = {
  ...
  "home.intro2": "Here I publish writeups, notes and projects I'm working on.",
  ...
  "panel.onpage": "on this page",

  "post.read": "read",

  "footer.served": "self-hosted",
  ...
  "meta.usesLede": "What I type on, what I type into, and what it all runs on.",
  "uses.unset": "(unset)",
  "meta.nowTitle": "Now",
  ...
  "err.body": "It may have moved, or it may never have existed.",
...
const ptBR: Record<UIKey, string> = {
  ...
  "site.tagline": "sistemas * backend * segurança ofensiva",
